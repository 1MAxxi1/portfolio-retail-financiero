...
SELECT 
    ...
    COUNT(*) AS total_registros,
    SUM(CASE WHEN TRIM(nombre_completo) LIKE ' %' OR nombre_completo LIKE '% ' THEN 1 ELSE 0 END) AS nombres_con_espacios,
    SUM(CASE WHEN limite_credito = '' THEN 1 ELSE 0 END) AS limites_vacios_detectados,
